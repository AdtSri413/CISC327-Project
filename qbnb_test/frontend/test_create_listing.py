...
class FrontEndCreateListingTest(BaseCase):
    ...
    Partitions for the Description Box:
      - P5: Description is between 20 and 2000 characters long, is longer than the title
    ...
    T2: Utilises OUTPUT PARTITION TESTING to test all possible output partitions
    
    Output partitions:
      - P1: Listing is created. Website sends user back to homepage and displays a new listing

        NOTE: If exhaustive output coverage testing were used, we would have to test for all 
              the possible listings that could be created, which is not feasible.
      
      - P2: Listing cannot be created because of invalid inputs. 
        Website keeps user on the create listing page and displays an error message.
      
      - P3: There is an invalid input parameter, but the website catches it before attempting 
        to create a listing. Website keeps user on the create listing page, but does not 
        display error message.

        NOTE: A warning flag is shown in this case, but it is not an element on the website,
              so it's presence cannot be tested for. 
    ...
    # T1-P1, T1-P5, T1-P10, T2-P1, T3-R1-P1, T3-R2-P1, T3-R3-P2, T3-R4-P1, T3-R5-P2
    ...
    def test_description_shorter_than_title(self, *_):
        ...
        self.type("#title", "A Long Listing Title That is Longer Than the Description")
    ...
    def test_high_price(self, *_):
        self.create_user_and_login("Example10", "example10@gmail.com", "Examp!3")
    ...
    def test_prefix_space(self, *_):
        self.create_user_and_login("Example11", "example11@gmail.com", "Examp!3")
    ...
    def test_suffix_space(self, *_):
        self.create_user_and_login("Example12", "example12@gmail.com", "Examp!3")
    ...
    def test_create_2_different_listings(self, *_):
        self.create_user_and_login("Example13", "example13@gmail.com", "Examp!3")
    ...
    def test_create_2_equal_listings(self, *_):
        self.create_user_and_login("Example14", "example14@gmail.com", "Examp!3")
